...
SAMPLE_ITINERARY = json.dumps({
    "overview": "India offers a vibrant mix of heritage, nature, and culture. This itinerary highlights famous Indian tourist places where visitors can enjoy iconic landmarks and local experiences.",
    "budget_breakdown": {
        "accommodation": 17500, "food": 12500, "transportation": 10000,
        "activities": 7500, "miscellaneous": 2500, "total": 50000
    },
    "travel_tips": [
        "Use prepaid tourist SIM cards and local apps for transport and navigation.",
        "Always keep a water bottle and sunscreen for daytime sightseeing.",
        "Respect local dress codes at temples and heritage sites.",
        "Book popular attractions in advance to avoid long queues.",
        "Try authentic regional cuisine from street food vendors and local cafés."
    ],
    "days": [
        {
...
with app.app_context():
    ...
    print("[SUCCESS] Database initialized with sample user and trip.")
